...
SettingMapping settings_map[] = {
    ...
    {"sniff_data_rate",
     ...
     SETTING_TYPE_STRING},
     {"badmouse_min_channel",
     &nrf24Tool_settings.badmouse_settings[BADMOUSE_SETTING_MIN_CHANNEL].value.u8,
     SETTING_TYPE_UINT8},
     {"badmouse_max_channel",
     &nrf24Tool_settings.badmouse_settings[BADMOUSE_SETTING_MAX_CHANNEL].value.u8,
     SETTING_TYPE_UINT8},
     {"badmouse_data_rate",
